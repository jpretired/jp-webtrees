...
<?php
	...
	private function show() {
		global $controller, $WT_TREE;
		$items_header_description = '<img src="data/magaziny/Scroll-Feather-icon-128.png" align="left" id="obrazek-odkazy" height="96"><p><br />Na této stránce se nacházejí všeobecné informace, které pokládáme za užitečné při bádání v historii rodů, zajímavé nebo zábavné. Časem mohou přibýt další.</p>';//Add your own header here.
